...
while True:
    ...
    uppergyroZ = 100
    lowergyroZ = -100
    vertical_rotation_upperAccX = 80
    vertical_rotation_upperAccY = 80
    vertical_rotation_lowerAccY = -80
    vertical_rotation_uppergyroY = 80
    vertical_rotation_lowergyroY = -80
    
    
    #classifier
    if 1:
        if AccXangle < lowerAccX or AccXangle > upperAccX:
            print("Motion detected: forward");
        elif AccYangle < lowerAccY or AccYangle > upperAccY:
            print("Motion detected: lift");
    if 1:
        if gyroZangle > uppergyroZ:
            print("Motion detected: horizontal anticlockwise turn");
        elif gyroZangle < lowergyroZ:
            print("Motion detected: horizontal clockwise turn");
        elif AccXangle > vertical_rotation_upperAccX and AccYangle > vertical_rotation_upperAccY and gyroYangle > vertical_rotation_uppergyroY :
            print("Motion detected: vertical left rotation");
        elif AccXangle > vertical_rotation_upperAccX and AccYangle < vertical_rotation_lowerAccY and gyroYangle < vertical_rotation_lowergyroY :
            print("Motion detected: vertical right rotation");
